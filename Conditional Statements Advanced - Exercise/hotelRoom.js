...
if(stay > 7 && stay <= 14){
    ...
    switch(month){
        ...
        case "October" :
            ...
            priceForApart = 65 * stay;break;
        case "June" :
        case "September" :
            priceForStudio = 75.20 * stay;
            priceForApart = 68.70 * stay;break;
        case "July" :
        case "August" :
            priceForStudio = 76 * stay;
            priceForApart = 77 * stay;break;
    }
} else if(stay > 14){
    ...
    switch(month){
        ...
        case "October" :
            ...
            priceForApart = 65 * 0.90 * stay;break;
        case "June" :
        case "September" :
            priceForStudio = 75.20 * 0.80 * stay;
            priceForApart = 68.70 * 0.90 * stay;break;
        case "July" :
        case "August" :
            priceForStudio = 76 * stay;
            priceForApart = 77 * 0.90 * stay;break;
        }
    } else {
